    ...
    public partial class ConsumHabitatgesModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Ingres_promig", @"Ingres_promig"),new InputOutputColumnPair(@"Poblacio_menor16", @"Poblacio_menor16"),new InputOutputColumnPair(@"Poblacio_estudis", @"Poblacio_estudis"),new InputOutputColumnPair(@"Persones_habitatge", @"Persones_habitatge"),new InputOutputColumnPair(@"Tipus_habitatge", @"Tipus_habitatge"),new InputOutputColumnPair(@"Lavabos_habitatge", @"Lavabos_habitatge"),new InputOutputColumnPair(@"Rentavaixelles", @"Rentavaixelles"),new InputOutputColumnPair(@"Us_banyera", @"Us_banyera"),new InputOutputColumnPair(@"Wc_diari", @"Wc_diari"),new InputOutputColumnPair(@"Dutxes_diari", @"Dutxes_diari"),new InputOutputColumnPair(@"Tipus_caldera", @"Tipus_caldera"),new InputOutputColumnPair(@"Antiguitat_caldera", @"Antiguitat_caldera"),new InputOutputColumnPair(@"Caldera_antiga", @"Caldera_antiga"),new InputOutputColumnPair(@"Distancia_caldera_dutxa", @"Distancia_caldera_dutxa"),new InputOutputColumnPair(@"Temps_aigua_calenta", @"Temps_aigua_calenta"),new InputOutputColumnPair(@"Tipus_descarrega", @"Tipus_descarrega"),new InputOutputColumnPair(@"Cisterna_capacitat", @"Cisterna_capacitat"),new InputOutputColumnPair(@"Seguiment_factura", @"Seguiment_factura"),new InputOutputColumnPair(@"Estalvies_aigua", @"Estalvies_aigua")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Ingres_promig",@"Poblacio_menor16",@"Poblacio_estudis",@"Persones_habitatge",@"Tipus_habitatge",@"Lavabos_habitatge",@"Rentavaixelles",@"Us_banyera",@"Wc_diari",@"Dutxes_diari",@"Tipus_caldera",@"Antiguitat_caldera",@"Caldera_antiga",@"Distancia_caldera_dutxa",@"Temps_aigua_calenta",@"Tipus_descarrega",@"Cisterna_capacitat",@"Seguiment_factura",@"Estalvies_aigua"}))      
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=8,MinimumExampleCountPerLeaf=7,NumberOfTrees=3098,MaximumBinCountPerFeature=38,FeatureFraction=0.790699163300247,LearningRate=0.06744135543746119,LabelColumnName=@"Consum_mensual_m3",FeatureColumnName=@"Features",DiskTranspose=false}));
